...
# .env
USERNAME="username"
DATABASE_URL="postgres://${USERNAME}@147.93.108.82/my_database"
```
```js
// index.js
...
```ini
# .env
DATABASE_URL="postgres://$(whoami)@147.93.108.82/my_database"
```
```js
// index.js
console.log('DATABASE_URL', process.env.DATABASE_URL)
...
DATABASE_URL postgres://yourusername@147.93.108.82/my_database
```
