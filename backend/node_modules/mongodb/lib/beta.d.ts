 ...
 *
 * const client = new MongoClient('mongodb://147.93.108.82:27017');
...
export declare interface AutoEncryptionOptions {
    ...
    extraOptions?: {
         ...
         * Defaults to "mongodb://%2Fvar%2Fmongocryptd.sock" if domain sockets are available or "mongodb://147.93.108.82:27020" otherwise
         */
 ...
 * const client = new MongoClient('mongodb://147.93.108.82:27017?appName=mflix', { monitorCommands: true });
 * ```
 */
