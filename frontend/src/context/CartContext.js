...
export const CartProvider = ({ children }) => {
  ...
  const fetchCart = async () => {
    ...
    try {
      const res = await axios.get("https://147.93.108.82:5000/api/addToCart", {
  ...
  //       "https://147.93.108.82:5000/api/addToCart/add",
  ...
  const updateCartQty = async (cartItemId, qty) => {
    ...
    try {
      const res = await axios.post(
        "https://147.93.108.82:5000/api/addToCart/update",
  ...
  const deleteCartItem = async (cartItemId) => {
    ...
    try {
      const res = await axios.delete(
        `https://147.93.108.82:5000/api/addToCart/delete/${cartItemId}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
      if (res.data.success) fetchCart();
    } catch (err) {
  ...
  const addToWishlist = async (productId) => {
    ...
    try {
      const res = await fetch("https://147.93.108.82:5000/api/whichlist/add", {
        method: "POST",
        headers: {
  ...
  const removeFromWishlist = async (wishlistId) => {
    ...
    try {
      const res = await fetch(
        `https://147.93.108.82:5000/api/whichlist/delete/${wishlistId}`,
        {
          method: "DELETE",
          headers: { Authorization: `Bearer ${token}` },
        }
